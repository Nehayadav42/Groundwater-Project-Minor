...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if (!passwordRegex.test(password)) {
        res.status(400);
        throw new Error('Password must be at least 8 characters long and include at least one number and one special symbol');
    }

    // Check if user already exists (any role) by email
    ...
    try {
        ...
        // Handle race-condition duplicate key errors at DB level
